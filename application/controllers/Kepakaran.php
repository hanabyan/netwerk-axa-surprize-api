...
class Kepakaran extends REST_Controller {
  ...
  {
    $sql = "SELECT `pkr_id` AS `value`, `pkr_name` AS `label` FROM ".$this->_table." WHERE `status` = 1 ORDER BY `label`";
