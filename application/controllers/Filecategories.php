...
class Filecategories extends REST_Controller {
  ...
  {
    parent::__construct();
    $this->_table = 'product_doc_category';
    $this->_col_primary = 'pdc_id';
  ...
  {
    $sql = "SELECT `pdc_id` AS `value`, `pdc_name` AS `label` FROM ".$this->_table." WHERE `status` = 1 ORDER BY `label`";
